...
def write_positions_frac(
    ...
    # Build text block
    if header is "intermetiate":
        lines = ["%BLOCK positions_frac_intermediate"]
    elif header is "product":
    ...
    if header is "intermetiate":
        lines = ["%ENDBLOCK positions_frac_intermediate"]
    elif header is "product":
        lines = ["%ENDBLOCK positions_frac_product"]
    else:
...
def write_cell_file(
   ...
   # Make blocks for transition state calculations if needed
    if (positions_frac_intermediate is not None and positions_frac_product is not None):
        positions_frac_intermediate_block = write_positions_frac(positions_frac=positions_frac_intermediate)
        positions_frac_product_block = write_positions_frac(positions_frac=positions_frac_product)
